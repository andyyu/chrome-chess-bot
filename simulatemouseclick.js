var MOUSECLICK = MOUSECLICK || (function(){
    var _args = [];
    ...
    return {
        ...
        click : function() {
            simulate(squareMap[_args[0]], 'click');
            simulate(squareMap[_args[1]], 'click');
        }
    };
}());
...
for (var x = 0; x < 8; x++){
  for (var y = 0; y < 8; y ++) {
    var square = String.fromCharCode(97 + x) + (y + 1);
    var element = getSquareElement(square);
    squareMap[square] = element;
  }
}
